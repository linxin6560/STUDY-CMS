        ...
        <aside>
            <div id="sidebar" class="nav-collapse ">
                ...
                <#if SESSION_ADMIN.isAdmin>
                    <li class="">
                        <a <#if menu="article">class="active"</#if> href="${BASE_PATH}/manage/article/list.htm">
                            <i class="icon-book"></i> <span>文章列表</span></a>
                    </li>
                    <li class="sub-menu">
                        <a href="${BASE_PATH}/manage/headline/list.htm" <#if menu="headline">class="active"</#if>>
                            <i class="icon-desktop"></i> <span>首页头条</span></a>
                    </li>
                    <li class="">
                        <a <#if menu="folder">class="active"</#if> href="${BASE_PATH}/manage/folder/list.htm">
                            <i class="icon-folder-open"></i> <span>目录列表</span></a>
                    </li>
                    <li class="">
                        <a <#if menu="album">class="active"</#if> href="${BASE_PATH}/manage/album/list.htm">
                            <i class="icon-picture"></i> <span>相册列表</span></a>
                    </li>
                    <li class="">
                        <a <#if menu="message">class="active"</#if> href="${BASE_PATH}/manage/guestbook/list.htm">
                            <i class="icon-comments"></i> <span>留言列表</span></a>
                    </li>
                    <li class="">
                        <a <#if menu="admin_list">class="active"</#if> href="${BASE_PATH}/manage/admin/manage.htm">
                            <i class="icon-user"></i> <span>管理员管理</span></a>
                    </li>
                    <li class="">
