...
<section id="main-content">
    <section class="wrapper">
        <!-- page start-->
        <form id="update_article_form" class="form-horizontal" action="${BASE_PATH}/manage/article/update.json"
                                        ...
                                        <#list folderAll as folder>
                                            <#if folder.owner == "yes">
                                                <option value="${folder.folderId}"
                                                        <#if folder.folderId==article.folderId>selected</#if>>
                                                ${folder.pathName}
                                                </option>
                                            </#if>
                                        </#list>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" data-link-format="yyyy-mm-dd" data-date-format="yyyy-MM-dd"
                                               style="font-size:15px;" class="js_create_time" name="createTime"
                                               placeholder="发布时间" id="createTime"
                                               value="${article.createTime?string("yyyy-MM-dd")}" readonly>
                                        </input>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10" style="margin-bottom:10px;">
                                        <input name="status" value="display" type="radio"
                                               <#if article.status=="display" || article.status=="init">checked</#if>>
                                        显示
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        <input name="status" value="hidden" type="radio"
                                               <#if article.status=="hidden">checked</#if>> 隐藏
                                    </div>
                                </div>
                                <div class="form-group">
    ...
    $.extend({
        ...
        addAttachment: function (list) {
            ...
            $('#attachment .js_picture').click(function () {
                $.post("${BASE_PATH}/manage/article/update_picture.json", {
            ...
            $('#attachment .js_link').click(function () {
                ...
                bootbox.prompt("为此附件增加链接", function (result) {
                    if (result != "") {
                        $.post("${BASE_PATH}/manage/attachment/update_link.json", {
