...
public class ArticleService {
     ...
     * @throws FolderNotFoundException
     */
    public PageVo<ArticleVo> getArticlePageByFolderId(long adminId, long folderId, ArticleConstant.check check, int pageNum)
            throws FolderNotFoundException {
        PageVo<ArticleVo> pageVo = new PageVo<ArticleVo>(pageNum);
        pageVo.setRows(20);
        List<ArticleVo> list;
        ...
        if (folderId == 0) {
            ...
            list = this.getArticleListByAdminIdAndFolderId(adminId, 0, check, pageVo.getOffset(), pageVo.getRows());
        } else {
            list = this.getArticleListByAdminIdAndFolderId(adminId, folderId, check, pageVo.getOffset(), pageVo.getRows());
    ...
    public List<ArticleVo> getArticleListByAdminIdAndFolderId(long adminId,
        ...
        return articleDao.getArticleListByAdminIdAndPath(adminId, path, check, offset, rows);
    }
